...
import { Flag, Mail, Lock, Eye, EyeOff, ArrowLeft, User } from 'lucide-react';
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <Card className="border-0 shadow-2xl bg-card/95 backdrop-blur-sm">
          <CardHeader className="text-center pb-6">
            ...
            <CardTitle className="text-2xl font-bold font-racing">Join the Race</CardTitle>
            <p className="text-muted-foreground">Create your racing account</p>
          </CardHeader>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="newsletter" className="text-sm">
                    Subscribe to racing updates and exclusive offers
                  </Label>
                </div>
              </div>
